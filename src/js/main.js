...
const readOnlyFromClient = urlParams.get("readOnly") || false;
    ...
    $(document).ready(function () {
      ...
      `;
        ...
        if (process.env.NODE_ENV === "production") {
            if (ConfigService.readOnlyOnWhiteboardLoad || readOnlyFromClient) ReadOnlyService.activateReadOnlyMode();
